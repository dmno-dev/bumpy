...
function makePkg(
  ...
  version: string,
  deps: Partial<
    Pick<WorkspacePackage, 'dependencies' | 'devDependencies' | 'peerDependencies' | 'optionalDependencies' | 'bumpy'>
  > = {},
): WorkspacePackage {
  return {
    name,
